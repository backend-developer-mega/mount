...
class Job(models.Model):
    ...
    name = fields.Char(string='Departamento', required=True, index=True, translate=True)
    ...
    no_of_recruitment = fields.Integer(string='Expected New Employees', copy=False,
        help='Numero de estudiantes egresados inscritos en este departamento.', default=1)
    no_of_hired_employee = fields.Integer(string='Egresados inscritos', copy=False,
